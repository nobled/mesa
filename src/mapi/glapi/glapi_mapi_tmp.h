...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_693)(GLfloat x, GLfloat y, GLfloat z, GLfloat width, GLfloat height);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_694)(const GLfloat *coords);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_695)(GLint x, GLint y, GLint z, GLint width, GLint height);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_696)(const GLint *coords);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_697)(GLshort x, GLshort y, GLshort z, GLshort width, GLshort height);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_698)(const GLshort *coords);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_699)(GLfixed x, GLfixed y, GLfixed z, GLfixed width, GLfixed height);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_700)(const GLfixed *coords);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_701)(GLenum type, GLsizei stride, const GLvoid *pointer);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_702)(GLenum pname, GLfloat *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_703)(GLenum pname, GLint *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_704)(GLenum pname, GLfloat param);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_705)(GLenum pname, const GLfloat *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_706)(GLenum pname, GLint param);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_707)(GLenum pname, const GLint *params);
GLbitfield APIENTRY GLAPI_PREFIX(_dispatch_stub_708)(GLfixed *mantissa, GLint *exponent);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_709)(GLclampf value, GLboolean invert);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_710)(GLenum pattern);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_745)(GLenum mode);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_787)(const GLenum *mode, const GLint *first, const GLsizei *count, GLsizei primcount, GLint modestride);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_788)(const GLenum *mode, const GLsizei *count, GLenum type, const GLvoid * const *indices, GLsizei primcount, GLint modestride);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_789)(GLsizei n, const GLuint *fences);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_790)(GLuint fence);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_791)(GLsizei n, GLuint *fences);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_792)(GLuint fence, GLenum pname, GLint *params);
GLboolean APIENTRY GLAPI_PREFIX(_dispatch_stub_793)(GLuint fence);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_794)(GLuint fence, GLenum condition);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_876)(GLenum face);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_877)(GLuint array);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_878)(GLsizei n, const GLuint *arrays);
GLAPI void APIENTRY GLAPI_PREFIX(DeleteVertexArrays)(GLsizei n, const GLuint *arrays);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_879)(GLsizei n, GLuint *arrays);
GLboolean APIENTRY GLAPI_PREFIX(_dispatch_stub_880)(GLuint array);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_889)(GLenum func, GLclampx ref);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_890)(GLclampx red, GLclampx green, GLclampx blue, GLclampx alpha);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_891)(GLclampx depth);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_892)(GLenum plane, const GLfixed *equation);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_893)(GLfixed red, GLfixed green, GLfixed blue, GLfixed alpha);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_894)(GLclampx zNear, GLclampx zFar);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_895)(GLenum pname, GLfixed param);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_896)(GLenum pname, const GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_897)(GLfixed left, GLfixed right, GLfixed bottom, GLfixed top, GLfixed zNear, GLfixed zFar);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_898)(GLenum plane, GLfixed *equation);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_899)(GLenum pname, GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_900)(GLenum light, GLenum pname, GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_901)(GLenum face, GLenum pname, GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_902)(GLenum target, GLenum pname, GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_903)(GLenum coord, GLenum pname, GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_904)(GLenum target, GLenum pname, GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_905)(GLenum pname, GLfixed param);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_906)(GLenum pname, const GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_907)(GLenum light, GLenum pname, GLfixed param);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_908)(GLenum light, GLenum pname, const GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_909)(GLfixed width);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_910)(const GLfixed *m);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_911)(GLenum face, GLenum pname, GLfixed param);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_912)(GLenum face, GLenum pname, const GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_913)(const GLfixed *m);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_914)(GLenum target, GLfixed s, GLfixed t, GLfixed r, GLfixed q);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_915)(GLfixed nx, GLfixed ny, GLfixed nz);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_916)(GLfixed left, GLfixed right, GLfixed bottom, GLfixed top, GLfixed zNear, GLfixed zFar);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_917)(GLenum pname, GLfixed param);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_918)(GLenum pname, const GLfixed *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_919)(GLfixed size);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_920)(GLfixed factor, GLfixed units);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_921)(GLfixed angle, GLfixed x, GLfixed y, GLfixed z);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_922)(GLclampx value, GLboolean invert);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_923)(GLfixed x, GLfixed y, GLfixed z);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_926)(GLenum coord, GLenum pname, GLint param);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_927)(GLenum coord, GLenum pname, const GLfixed *params);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_931)(GLenum plane, const GLfloat *equation);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_932)(GLfloat left, GLfloat right, GLfloat bottom, GLfloat top, GLfloat zNear, GLfloat zFar);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_933)(GLenum plane, GLfloat *equation);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_935)(GLclampd zmin, GLclampd zmax);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_936)(GLenum modeRGB, GLenum modeA);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_954)(GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, GLbitfield mask, GLenum filter);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_955)(GLenum target, GLenum pname, GLint param);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_956)(GLenum target, GLintptr offset, GLsizeiptr size);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1014)(GLenum target, GLenum pname, GLvoid **params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1015)(GLenum target, GLsizei length, GLvoid *pointer);
...
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1023)(GLenum frontfunc, GLenum backfunc, GLint ref, GLuint mask);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1024)(GLenum target, GLuint index, GLsizei count, const GLfloat *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1025)(GLenum target, GLuint index, GLsizei count, const GLfloat *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1026)(GLuint id, GLenum pname, GLint64EXT *params);
void APIENTRY GLAPI_PREFIX(_dispatch_stub_1027)(GLuint id, GLenum pname, GLuint64EXT *params);
